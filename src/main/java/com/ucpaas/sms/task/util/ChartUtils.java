...
//		return timeseries;
		...
		TimeSeries s1 = new TimeSeries(category);
		
		s1.add(new Day(1, 1, 2017),0);
        s1.add(new Day(2, 1, 2017),0);
        s1.add(new Day(3, 1, 2017),0);
        s1.add(new Day(4, 1, 2017),0);
        s1.add(new Day(5, 1, 2017),0);
        
        s1.add(new Day(6, 1, 2017),0);
        s1.add(new Day(7, 1, 2017),0);
        s1.add(new Day(8, 1, 2017),0);
...
//
	...
	public static TimeSeries createTimeseries() {
		...
		s1.add(new Day(1, 1, 2017),0.00);
		s1.add(new Day(2, 1, 2017),0.00);
		s1.add(new Day(3, 1, 2017),0.00);
		s1.add(new Day(4, 1, 2017),0.00);
		s1.add(new Day(5, 1, 2017),0.00);
	...
	public static TimeSeriesCollection createDataset(List<Map<String,Object>> list,StringBuffer sbflag) {
		...
		for(int i = 0;i < list.size(); i++){
			...
			String data_str = data.get("date").toString();
...
//			gd_value =  gd_value.setScale(3, BigDecimal.ROUND_HALF_UP);
		...
		if("".equals(sbflag.toString())){
			sbflag.append("allZero");
		}
