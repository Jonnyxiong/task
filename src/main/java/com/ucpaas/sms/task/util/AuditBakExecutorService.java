...
public class AuditBakExecutorService {


    public static volatile boolean isShutdown = false;

    private static ExecutorService executorService = Executors.newFixedThreadPool(Integer.valueOf(ConfigUtils.audit_sms_bak_thread_size));
    ...
    public static boolean canRunning(){
        return DateUtil.isBetween(ConfigUtils.audit_sms_bak_running_begin,ConfigUtils.audit_sms_bak_running_end);
    }
}
